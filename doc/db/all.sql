...
insert into chapter (id, course_id, name)
values ('00000015', '00000000', '测试大章15');
insert into chapter (id, course_id, name)
...
values ('00000100', '00000000', '电视剧', 100);
insert into `category` (id, parent, name, sort)
values ('00000101', '00000100', '喜剧', 101);
insert into `category` (id, parent, name, sort)
values ('00000102', '00000100', '战争', 102);
insert into `category` (id, parent, name, sort)
values ('00000103', '00000100', '古装', 103);
insert into `category` (id, parent, name, sort)
values ('00000104', '00000100', '都市', 104);
insert into `category` (id, parent, name, sort)
values ('00000105', '00000100', '谍战', 105);
insert into `category` (id, parent, name, sort)
values ('00000106', '00000100', '武侠', 106);
insert into `category` (id, parent, name, sort)
values ('00000107', '00000100', '奇幻', 107);
insert into `category` (id, parent, name, sort)
values ('00000108', '00000100', '短剧', 108);
insert into `category` (id, parent, name, sort)
values ('00000200', '00000000', '综艺', 200);
insert into `category` (id, parent, name, sort)
values ('00000201', '00000200', '音乐', 201);
insert into `category` (id, parent, name, sort)
values ('00000202', '00000200', '脱口秀', 202);
insert into `category` (id, parent, name, sort)
values ('00000203', '00000200', '访谈', 203);
insert into `category` (id, parent, name, sort)
values ('00000204', '00000200', '美食', 204);
insert into `category` (id, parent, name, sort)
values ('00000205', '00000200', '旅游', 205);
insert into `category` (id, parent, name, sort)
values ('00000206', '00000200', '演唱会', 206);
insert into `category` (id, parent, name, sort)
values ('00000300', '00000000', '音乐', 300);
insert into `category` (id, parent, name, sort)
values ('00000301', '00000300', 'MV', 301);
insert into `category` (id, parent, name, sort)
values ('00000302', '00000300', '音乐现场', 302);
insert into `category` (id, parent, name, sort)
values ('00000303', '00000300', '翻唱', 303);
insert into `category` (id, parent, name, sort)
values ('00000304', '00000300', '音乐教学', 304);
insert into `category` (id, parent, name, sort)
values ('00000400', '00000000', '知识', 400);
insert into `category` (id, parent, name, sort)
values ('00000401', '00000400', '科学科普', 401);
insert into `category` (id, parent, name, sort)
values ('00000402', '00000400', '人文历史', 402);
insert into `category` (id, parent, name, sort)
values ('00000403', '00000400', '校园学习', 403);
insert into `category` (id, parent, name, sort)
values ('00000404', '00000400', '职业职场', 404);
insert into `category` (id, parent, name, sort)
values ('00000405', '00000400', '设计', 405);
insert into `category` (id, parent, name, sort)
values ('00000500', '00000000', '电影', 500);
insert into `category` (id, parent, name, sort)
values ('00000501', '00000500', '喜剧', 501);
insert into `category` (id, parent, name, sort)
values ('00000502', '00000500', '励志', 502);
insert into `category` (id, parent, name, sort)
values ('00000503', '00000500', '科幻', 503);
insert into `category` (id, parent, name, sort)
values ('00000504', '00000500', '犯罪', 504);
insert into `category` (id, parent, name, sort)
values ('00000505', '00000500', '恐怖', 505);
insert into `category` (id, parent, name, sort)
values ('00000506', '00000500', '悬疑', 506);
insert into `category` (id, parent, name, sort)
values ('00000507', '00000500', '爱情', 507);
insert into `category` (id, parent, name, sort)
values ('00000600', '00000000', '记录片', 600);
insert into `category` (id, parent, name, sort)
values ('00000601', '00000600', '动物', 601);
insert into `category` (id, parent, name, sort)
values ('00000602', '00000600', '人文', 602);
insert into `category` (id, parent, name, sort)
values ('00000603', '00000600', '历史', 603);
insert into `category` (id, parent, name, sort)
values ('00000604', '00000600', '宇宙', 604);
insert into `category` (id, parent, name, sort)
values ('00000605', '00000600', '科技', 605);
insert into `category` (id, parent, name, sort)
values ('00000606', '00000600', '美食', 606);
insert into `category` (id, parent, name, sort)
values ('00000700', '00000000', '游戏', 700);
insert into `category` (id, parent, name, sort)
values ('00000701', '00000700', '手机游戏', 701);
insert into `category` (id, parent, name, sort)
values ('00000702', '00000700', '网络游戏', 702);
insert into `category` (id, parent, name, sort)
values ('00000703', '00000700', '桌牌游戏', 703);
